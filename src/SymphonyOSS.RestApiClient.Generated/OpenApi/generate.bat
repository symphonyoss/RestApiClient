...
java -jar swagger-codegen-cli.jar generate -i Yaml/1.46/agentAPI.yaml -l csharp -o Temp -c Config/agentApi.json
java -jar swagger-codegen-cli.jar generate -i Yaml/1.46/authenticatorAPI.yaml -l csharp -o Temp -c Config/authenticatorApi.json
java -jar swagger-codegen-cli.jar generate -i Yaml/1.46/podAPI.yaml -l csharp -o Temp -c Config/podApi.json
rmdir /s /q AgentApi
