...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AuthenticatorApi.Model
{
    ...
    public partial class OboAuthResponse :  IEquatable<OboAuthResponse>
    {
        ...
        /// <param name="AgentUrl">This is a fully qualified URL for 3rd party application to talk to the Agent. .</param>
        public OboAuthResponse(string SessionToken = null, string AgentUrl = null)
        {
        ...
        /// <summary>
        /// This is a fully qualified URL for 3rd party application to talk to the Agent. 
        /// </summary>
        /// <value>This is a fully qualified URL for 3rd party application to talk to the Agent. </value>
        ...
        public bool Equals(OboAuthResponse other)
        {
            ...
            return 
                ...
                (
                    this.AgentUrl == other.AgentUrl ||
                    this.AgentUrl != null &&
                    this.AgentUrl.Equals(other.AgentUrl)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AgentUrl != null)
                    hash = hash * 59 + this.AgentUrl.GetHashCode();
                return hash;
            }
        }
    }
