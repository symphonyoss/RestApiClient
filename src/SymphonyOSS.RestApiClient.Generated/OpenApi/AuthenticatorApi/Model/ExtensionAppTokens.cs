...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AuthenticatorApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExtensionAppTokens :  IEquatable<ExtensionAppTokens>, IValidatableObject
    {
        /// <summary>
        ...
        public ExtensionAppTokens(string AppId = default(string), string AppToken = default(string), string SymphonyToken = default(string), long? ExpireAt = default(long?))
        {
            this.AppId = AppId;
