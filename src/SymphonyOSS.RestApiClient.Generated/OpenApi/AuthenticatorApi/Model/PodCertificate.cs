...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AuthenticatorApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PodCertificate :  IEquatable<PodCertificate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PodCertificate" /> class.
        /// </summary>
        /// <param name="Certificate">Certificate in PEM format.</param>
        public PodCertificate(string Certificate = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PodCertificate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PodCertificate);
        }

        /// <summary>
        /// Returns true if PodCertificate instances are equal
        /// </summary>
        /// <param name="other">Instance of PodCertificate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PodCertificate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
