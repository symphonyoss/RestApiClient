...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AuthenticatorApi.Api
{
    ...
    /// </summary>
    public interface IPodApi : IApiAccessor
    {
        ...
        /// <returns>PodCertificate</returns>
        ...
        /// </remarks>
        /// <exception cref="SymphonyOSS.RestApiClient.Generated.OpenApi.AuthenticatorApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of PodCertificate</returns>
        ApiResponse<PodCertificate> V1AppPodCertificateGetWithHttpInfo ();
        ...
        /// </remarks>
        /// <exception cref="SymphonyOSS.RestApiClient.Generated.OpenApi.AuthenticatorApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of PodCertificate</returns>
        System.Threading.Tasks.Task<PodCertificate> V1AppPodCertificateGetAsync ();
        ...
        /// </remarks>
        /// <exception cref="SymphonyOSS.RestApiClient.Generated.OpenApi.AuthenticatorApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (PodCertificate)</returns>
        System.Threading.Tasks.Task<ApiResponse<PodCertificate>> V1AppPodCertificateGetAsyncWithHttpInfo ();
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PodApi : IPodApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PodApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PodApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PodApi(Configuration configuration = null)
        {
        ...
        /// <exception cref="SymphonyOSS.RestApiClient.Generated.OpenApi.AuthenticatorApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>PodCertificate</returns>
        public PodCertificate V1AppPodCertificateGet ()
        {
             ApiResponse<PodCertificate> localVarResponse = V1AppPodCertificateGetWithHttpInfo();
        ...
        /// <exception cref="SymphonyOSS.RestApiClient.Generated.OpenApi.AuthenticatorApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of PodCertificate</returns>
        public ApiResponse< PodCertificate > V1AppPodCertificateGetWithHttpInfo ()
        {

            var localVarPath = "/v1/app/pod/certificate";
            ...
            {
                Exception exception = ExceptionFactory("V1AppPodCertificateGet", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<PodCertificate>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PodCertificate) Configuration.ApiClient.Deserialize(localVarResponse, typeof(PodCertificate)));
        ...
        /// <exception cref="SymphonyOSS.RestApiClient.Generated.OpenApi.AuthenticatorApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of PodCertificate</returns>
        public async System.Threading.Tasks.Task<PodCertificate> V1AppPodCertificateGetAsync ()
        {
             ApiResponse<PodCertificate> localVarResponse = await V1AppPodCertificateGetAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="SymphonyOSS.RestApiClient.Generated.OpenApi.AuthenticatorApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (PodCertificate)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PodCertificate>> V1AppPodCertificateGetAsyncWithHttpInfo ()
        {
