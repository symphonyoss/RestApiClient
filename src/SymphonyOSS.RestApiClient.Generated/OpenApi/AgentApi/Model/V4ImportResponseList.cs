...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4ImportResponseList : List<V4ImportResponse>,  IEquatable<V4ImportResponseList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V4ImportResponseList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public V4ImportResponseList()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V4ImportResponseList {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4ImportResponseList);
        }

        /// <summary>
        /// Returns true if V4ImportResponseList instances are equal
        /// </summary>
        /// <param name="other">Instance of V4ImportResponseList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4ImportResponseList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
