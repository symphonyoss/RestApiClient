...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    public partial class V2MessageSubmission :  IEquatable<V2MessageSubmission>, IValidatableObject
    {
        ...
        public V2MessageSubmission(FormatEnum? Format = default(FormatEnum?), string Message = default(string), List<AttachmentInfo> Attachments = default(List<AttachmentInfo>))
        {
            this.Format = Format;
