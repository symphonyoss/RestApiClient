...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4UserJoinedRoom :  IEquatable<V4UserJoinedRoom>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>User who was affected by the action (i.e. added to the room)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V4UserJoinedRoom {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4UserJoinedRoom);
        }

        /// <summary>
        /// Returns true if V4UserJoinedRoom instances are equal
        /// </summary>
        /// <param name="other">Instance of V4UserJoinedRoom to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4UserJoinedRoom other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
