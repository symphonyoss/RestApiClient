...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2ImportResponse :  IEquatable<V2ImportResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ImportResponse" /> class.
        /// </summary>
        ...
        public V2ImportResponse(string MessageId = default(string), string OriginatingSystemId = default(string), string OriginalMessageId = default(string), string Diagnostic = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2ImportResponse);
        }

        /// <summary>
        /// Returns true if V2ImportResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V2ImportResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2ImportResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
