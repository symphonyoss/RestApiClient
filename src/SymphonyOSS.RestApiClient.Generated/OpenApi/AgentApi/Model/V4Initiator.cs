...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4Initiator :  IEquatable<V4Initiator>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4Initiator);
        }

        /// <summary>
        /// Returns true if V4Initiator instances are equal
        /// </summary>
        /// <param name="other">Instance of V4Initiator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4Initiator other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
