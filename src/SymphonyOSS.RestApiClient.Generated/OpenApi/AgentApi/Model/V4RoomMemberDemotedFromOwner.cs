...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4RoomMemberDemotedFromOwner :  IEquatable<V4RoomMemberDemotedFromOwner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V4RoomMemberDemotedFromOwner" /> class.
        /// </summary>
        /// <param name="Stream">Stream.</param>
        /// <param name="AffectedUser">User who was affected by the action (i.e. demoted from owner).</param>
        public V4RoomMemberDemotedFromOwner(V4Stream Stream = default(V4Stream), V4User AffectedUser = default(V4User))
        {
            this.Stream = Stream;
        ...
        /// </summary>
        /// <value>User who was affected by the action (i.e. demoted from owner)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V4RoomMemberDemotedFromOwner {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4RoomMemberDemotedFromOwner);
        }

        /// <summary>
        /// Returns true if V4RoomMemberDemotedFromOwner instances are equal
        /// </summary>
        /// <param name="other">Instance of V4RoomMemberDemotedFromOwner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4RoomMemberDemotedFromOwner other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
