...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4MessageList : List<V4Message>,  IEquatable<V4MessageList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V4MessageList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public V4MessageList()
        {
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4MessageList);
        }

        /// <summary>
        /// Returns true if V4MessageList instances are equal
        /// </summary>
        /// <param name="other">Instance of V4MessageList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4MessageList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
