...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageSubmission :  IEquatable<MessageSubmission>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Format
        /// </summary>
        ...
        public MessageSubmission(FormatEnum? Format = default(FormatEnum?), string Message = default(string))
        {
            this.Format = Format;
