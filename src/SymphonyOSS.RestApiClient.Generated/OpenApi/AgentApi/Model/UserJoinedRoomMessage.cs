...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    public partial class UserJoinedRoomMessage : V2BaseMessage,  IEquatable<UserJoinedRoomMessage>, IValidatableObject
    {
        ...
        public UserJoinedRoomMessage(string Id = default(string), string Timestamp = default(string), string V2messageType = default(string), string StreamId = default(string), long? AddedByUserId = default(long?), long? MemberAddedUserId = default(long?))
        {
