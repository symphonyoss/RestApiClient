...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4InstantMessageCreated :  IEquatable<V4InstantMessageCreated>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V4InstantMessageCreated {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4InstantMessageCreated);
        }

        /// <summary>
        /// Returns true if V4InstantMessageCreated instances are equal
        /// </summary>
        /// <param name="other">Instance of V4InstantMessageCreated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4InstantMessageCreated other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
