...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2MessageImportList : List<V2ImportedMessage>,  IEquatable<V2MessageImportList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2MessageImportList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public V2MessageImportList()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2MessageImportList {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2MessageImportList);
        }

        /// <summary>
        /// Returns true if V2MessageImportList instances are equal
        /// </summary>
        /// <param name="other">Instance of V2MessageImportList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2MessageImportList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
