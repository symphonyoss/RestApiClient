...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4RoomCreated :  IEquatable<V4RoomCreated>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets RoomProperties
        /// </summary>
        [DataMember(Name="roomProperties", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V4RoomCreated {\n");
            sb.Append("  Stream: ").Append(Stream).Append("\n");
            sb.Append("  RoomProperties: ").Append(RoomProperties).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4RoomCreated);
        }

        /// <summary>
        /// Returns true if V4RoomCreated instances are equal
        /// </summary>
        /// <param name="other">Instance of V4RoomCreated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4RoomCreated other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.RoomProperties == other.RoomProperties ||
                    this.RoomProperties != null &&
                    this.RoomProperties.Equals(other.RoomProperties)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RoomProperties != null)
                    hash = hash * 59 + this.RoomProperties.GetHashCode();
                return hash;
            }
        }
