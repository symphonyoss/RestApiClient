...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4ConnectionRequested :  IEquatable<V4ConnectionRequested>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>User who received the connection request</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V4ConnectionRequested {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4ConnectionRequested);
        }

        /// <summary>
        /// Returns true if V4ConnectionRequested instances are equal
        /// </summary>
        /// <param name="other">Instance of V4ConnectionRequested to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4ConnectionRequested other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
