...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoomMemberDemotedFromOwnerMessage : V2BaseMessage,  IEquatable<RoomMemberDemotedFromOwnerMessage>, IValidatableObject
    {
        /// <summary>
        ...
        public RoomMemberDemotedFromOwnerMessage(string Id = default(string), string Timestamp = default(string), string V2messageType = default(string), string StreamId = default(string), long? DemotedByUserId = default(long?), long? DemotedUserId = default(long?))
        {
