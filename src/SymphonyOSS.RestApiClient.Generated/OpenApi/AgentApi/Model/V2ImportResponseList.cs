...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2ImportResponseList : List<V2ImportResponse>,  IEquatable<V2ImportResponseList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ImportResponseList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public V2ImportResponseList()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2ImportResponseList {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2ImportResponseList);
        }

        /// <summary>
        /// Returns true if V2ImportResponseList instances are equal
        /// </summary>
        /// <param name="other">Instance of V2ImportResponseList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2ImportResponseList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
