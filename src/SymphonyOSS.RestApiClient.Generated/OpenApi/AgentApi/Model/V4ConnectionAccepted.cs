...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4ConnectionAccepted :  IEquatable<V4ConnectionAccepted>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>User who sent the connection request</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V4ConnectionAccepted {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4ConnectionAccepted);
        }

        /// <summary>
        /// Returns true if V4ConnectionAccepted instances are equal
        /// </summary>
        /// <param name="other">Instance of V4ConnectionAccepted to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4ConnectionAccepted other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
