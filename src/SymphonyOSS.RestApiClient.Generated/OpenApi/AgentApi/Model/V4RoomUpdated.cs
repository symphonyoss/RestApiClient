...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4RoomUpdated :  IEquatable<V4RoomUpdated>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets NewRoomProperties
        /// </summary>
        [DataMember(Name="newRoomProperties", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NewRoomProperties: ").Append(NewRoomProperties).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4RoomUpdated);
        }

        /// <summary>
        /// Returns true if V4RoomUpdated instances are equal
        /// </summary>
        /// <param name="other">Instance of V4RoomUpdated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4RoomUpdated other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.NewRoomProperties == other.NewRoomProperties ||
                    this.NewRoomProperties != null &&
                    this.NewRoomProperties.Equals(other.NewRoomProperties)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NewRoomProperties != null)
                    hash = hash * 59 + this.NewRoomProperties.GetHashCode();
                return hash;
            }
        }
