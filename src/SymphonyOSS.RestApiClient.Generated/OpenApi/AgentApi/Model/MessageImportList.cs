...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    public partial class MessageImportList : List<ImportedMessage>,  IEquatable<MessageImportList>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessageImportList);
        }

        /// <summary>
        /// Returns true if MessageImportList instances are equal
        /// </summary>
        /// <param name="other">Instance of MessageImportList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageImportList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
