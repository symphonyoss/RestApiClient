...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoomCreatedMessage : V2BaseMessage,  IEquatable<RoomCreatedMessage>, IValidatableObject
    {
        /// <summary>
        ...
        public RoomCreatedMessage(string Id = default(string), string Timestamp = default(string), string V2messageType = default(string), string StreamId = default(string), long? CreationDate = default(long?), string Name = default(string), List<RoomTag> Keywords = default(List<RoomTag>), string Description = default(string), long? CreatedByUserId = default(long?), bool? _ReadOnly = default(bool?), bool? Discoverable = default(bool?), bool? _Public = default(bool?), bool? MembersCanInvite = default(bool?), bool? CopyProtected = default(bool?))
        {
