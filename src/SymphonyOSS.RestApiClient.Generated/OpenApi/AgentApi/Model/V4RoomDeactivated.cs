...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4RoomDeactivated :  IEquatable<V4RoomDeactivated>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V4RoomDeactivated {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4RoomDeactivated);
        }

        /// <summary>
        /// Returns true if V4RoomDeactivated instances are equal
        /// </summary>
        /// <param name="other">Instance of V4RoomDeactivated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4RoomDeactivated other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
