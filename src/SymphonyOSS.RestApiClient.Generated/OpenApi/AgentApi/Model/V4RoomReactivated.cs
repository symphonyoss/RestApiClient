...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4RoomReactivated :  IEquatable<V4RoomReactivated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V4RoomReactivated" /> class.
        /// </summary>
        /// <param name="Stream">Stream.</param>
        public V4RoomReactivated(V4Stream Stream = default(V4Stream))
        {
            this.Stream = Stream;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V4RoomReactivated {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4RoomReactivated);
        }

        /// <summary>
        /// Returns true if V4RoomReactivated instances are equal
        /// </summary>
        /// <param name="other">Instance of V4RoomReactivated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4RoomReactivated other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
