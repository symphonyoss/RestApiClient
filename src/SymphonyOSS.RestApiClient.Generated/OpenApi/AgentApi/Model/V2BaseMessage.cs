...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2BaseMessage :  IEquatable<V2BaseMessage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2BaseMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V2BaseMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V2BaseMessage" /> class.
        /// </summary>
        ...
        public V2BaseMessage(string Id = null, string Timestamp = null, string V2messageType = null, string StreamId = null)
        {
            // to ensure "Timestamp" is required (not null)
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for V2BaseMessage and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("V2messageType is a required property for V2BaseMessage and cannot be null");
            }
            else
            {
            ...
            if (StreamId == null)
            {
                throw new InvalidDataException("StreamId is a required property for V2BaseMessage and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2BaseMessage);
        }

        /// <summary>
        /// Returns true if V2BaseMessage instances are equal
        /// </summary>
        /// <param name="other">Instance of V2BaseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2BaseMessage other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
