...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2BaseMessage :  IEquatable<V2BaseMessage>, IValidatableObject
    {
        /// <summary>
        ...
        public V2BaseMessage(string Id = default(string), string Timestamp = default(string), string V2messageType = default(string), string StreamId = default(string))
        {
