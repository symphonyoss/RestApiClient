...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4MessageImportList : List<V4ImportedMessage>,  IEquatable<V4MessageImportList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V4MessageImportList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public V4MessageImportList()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V4MessageImportList {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4MessageImportList);
        }

        /// <summary>
        /// Returns true if V4MessageImportList instances are equal
        /// </summary>
        /// <param name="other">Instance of V4MessageImportList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4MessageImportList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
