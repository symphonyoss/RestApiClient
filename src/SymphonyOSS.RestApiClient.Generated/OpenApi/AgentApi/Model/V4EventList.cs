...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4EventList : List<V4Event>,  IEquatable<V4EventList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V4EventList" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4EventList);
        }

        /// <summary>
        /// Returns true if V4EventList instances are equal
        /// </summary>
        /// <param name="other">Instance of V4EventList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4EventList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
