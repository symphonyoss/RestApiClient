...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    public partial class V2MessageList : List<V2BaseMessage>,  IEquatable<V2MessageList>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2MessageList);
        }

        /// <summary>
        /// Returns true if V2MessageList instances are equal
        /// </summary>
        /// <param name="other">Instance of V2MessageList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2MessageList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
