...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4UserLeftRoom :  IEquatable<V4UserLeftRoom>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V4UserLeftRoom" /> class.
        /// </summary>
        /// <param name="Stream">Stream.</param>
        /// <param name="AffectedUser">User who was affected by the action (i.e. left the room).</param>
        public V4UserLeftRoom(V4Stream Stream = default(V4Stream), V4User AffectedUser = default(V4User))
        {
            this.Stream = Stream;
        ...
        /// </summary>
        /// <value>User who was affected by the action (i.e. left the room)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V4UserLeftRoom {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4UserLeftRoom);
        }

        /// <summary>
        /// Returns true if V4UserLeftRoom instances are equal
        /// </summary>
        /// <param name="other">Instance of V4UserLeftRoom to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4UserLeftRoom other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
