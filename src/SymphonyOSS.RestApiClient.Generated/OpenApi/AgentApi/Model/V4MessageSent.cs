...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4MessageSent :  IEquatable<V4MessageSent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V4MessageSent" /> class.
        /// </summary>
        /// <param name="Message">Message.</param>
        public V4MessageSent(V4Message Message = default(V4Message))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4MessageSent);
        }

        /// <summary>
        /// Returns true if V4MessageSent instances are equal
        /// </summary>
        /// <param name="other">Instance of V4MessageSent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4MessageSent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
