...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    public partial class RoomUpdatedMessage : V2BaseMessage,  IEquatable<RoomUpdatedMessage>, IValidatableObject
    {
        ...
        public RoomUpdatedMessage(string Id = default(string), string Timestamp = default(string), string V2messageType = default(string), string StreamId = default(string), string OldName = default(string), string NewName = default(string), List<RoomTag> Keywords = default(List<RoomTag>), string OldDescription = default(string), string NewDescription = default(string), bool? MembersCanInvite = default(bool?), bool? Discoverable = default(bool?), bool? _ReadOnly = default(bool?), bool? CopyProtected = default(bool?))
        {
