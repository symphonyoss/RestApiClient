...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoomReactivatedMessage : V2BaseMessage,  IEquatable<RoomReactivatedMessage>, IValidatableObject
    {
        /// <summary>
        ...
        public RoomReactivatedMessage(string Id = default(string), string Timestamp = default(string), string V2messageType = default(string), string StreamId = default(string), long? ReactivatedByUserId = default(long?))
        {
