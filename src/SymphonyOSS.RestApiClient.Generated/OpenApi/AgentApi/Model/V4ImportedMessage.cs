...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V4ImportedMessage :  IEquatable<V4ImportedMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V4ImportedMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V4ImportedMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V4ImportedMessage" /> class.
        /// </summary>
        /// <param name="Message">Message text in MessageMLV2 (required).</param>
        /// <param name="Data">Entity data in EntityJSON.</param>
        ...
        public V4ImportedMessage(string Message = default(string), string Data = default(string), long? IntendedMessageTimestamp = default(long?), long? IntendedMessageFromUserId = default(long?), string OriginatingSystemId = default(string), string OriginalMessageId = default(string), string StreamId = default(string))
        {
            // to ensure "Message" is required (not null)
            if (Message == null)
            {
                throw new InvalidDataException("Message is a required property for V4ImportedMessage and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IntendedMessageTimestamp is a required property for V4ImportedMessage and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IntendedMessageFromUserId is a required property for V4ImportedMessage and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("OriginatingSystemId is a required property for V4ImportedMessage and cannot be null");
            }
            else
            {
            ...
            if (StreamId == null)
            {
                throw new InvalidDataException("StreamId is a required property for V4ImportedMessage and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Message text in MessageMLV2</value>
        [DataMember(Name="message", EmitDefaultValue=false)]
        public string Message { get; set; }
        /// <summary>
        /// Entity data in EntityJSON
        /// </summary>
        /// <value>Entity data in EntityJSON</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V4ImportedMessage);
        }

        /// <summary>
        /// Returns true if V4ImportedMessage instances are equal
        /// </summary>
        /// <param name="other">Instance of V4ImportedMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V4ImportedMessage other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
