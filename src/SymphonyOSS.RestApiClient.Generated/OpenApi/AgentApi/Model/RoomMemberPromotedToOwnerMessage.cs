...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoomMemberPromotedToOwnerMessage : V2BaseMessage,  IEquatable<RoomMemberPromotedToOwnerMessage>, IValidatableObject
    {
        /// <summary>
        ...
        public RoomMemberPromotedToOwnerMessage(string Id = default(string), string Timestamp = default(string), string V2messageType = default(string), string StreamId = default(string), long? PromotedByUserId = default(long?), long? PromotedUserId = default(long?))
        {
