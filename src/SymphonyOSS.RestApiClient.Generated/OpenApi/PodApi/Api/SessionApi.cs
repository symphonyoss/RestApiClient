...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.PodApi.Api
{
    ...
    public interface ISessionApi : IApiAccessor
    {
        ...
        UserV2 V2SessioninfoGet (string sessionToken);
        ...
        ApiResponse<UserV2> V2SessioninfoGetWithHttpInfo (string sessionToken);
        ...
        System.Threading.Tasks.Task<UserV2> V2SessioninfoGetAsync (string sessionToken);
        ...
        System.Threading.Tasks.Task<ApiResponse<UserV2>> V2SessioninfoGetAsyncWithHttpInfo (string sessionToken);
    ...
    public partial class SessionApi : ISessionApi
    {
        ...
        /// <param name="sessionToken">Session authentication token.</param>
        /// <returns>UserV2</returns>
        public UserV2 V2SessioninfoGet (string sessionToken)
        {
             ApiResponse<UserV2> localVarResponse = V2SessioninfoGetWithHttpInfo(sessionToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="sessionToken">Session authentication token.</param>
        /// <returns>ApiResponse of UserV2</returns>
        public ApiResponse< UserV2 > V2SessioninfoGetWithHttpInfo (string sessionToken)
        {
            // verify the required parameter 'sessionToken' is set
            if (sessionToken == null)
                throw new ApiException(400, "Missing required parameter 'sessionToken' when calling SessionApi->V2SessioninfoGet");

            var localVarPath = "/v2/sessioninfo";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("V2SessioninfoGet", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="sessionToken">Session authentication token.</param>
        /// <returns>Task of UserV2</returns>
        public async System.Threading.Tasks.Task<UserV2> V2SessioninfoGetAsync (string sessionToken)
        {
             ApiResponse<UserV2> localVarResponse = await V2SessioninfoGetAsyncWithHttpInfo(sessionToken);
             return localVarResponse.Data;
        ...
        /// <param name="sessionToken">Session authentication token.</param>
        /// <returns>Task of ApiResponse (UserV2)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UserV2>> V2SessioninfoGetAsyncWithHttpInfo (string sessionToken)
        {
            // verify the required parameter 'sessionToken' is set
            if (sessionToken == null)
                throw new ApiException(400, "Missing required parameter 'sessionToken' when calling SessionApi->V2SessioninfoGet");
