...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.PodApi.Model
{
    ...
    public partial class UserDetail :  IEquatable<UserDetail>, IValidatableObject
    {
        ...
        public UserDetail(UserAttributes UserAttributes = default(UserAttributes), UserSystemInfo UserSystemInfo = default(UserSystemInfo), IntegerList Features = default(IntegerList), IntegerList Apps = default(IntegerList), IntegerList Groups = default(IntegerList), StringList Roles = default(StringList), IntegerList Disclaimers = default(IntegerList), Avatar Avatar = default(Avatar))
        {
