...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.PodApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1ConfigurationResponse :  IEquatable<V1ConfigurationResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public V1ConfigurationResponse(string ConfigurationId = default(string), string Type = default(string), bool? Active = default(bool?), string Name = default(string), string Description = default(string), bool? Enabled = default(bool?), bool? Visible = default(bool?), long? Owner = default(long?))
        {
