...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.PodApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1ConfigurationSubmissionCreate :  IEquatable<V1ConfigurationSubmissionCreate>, IValidatableObject
    {
        /// <summary>
        ...
        public V1ConfigurationSubmissionCreate(string Type = default(string), string Name = default(string), string Description = default(string))
        {
            this.Type = Type;
            this.Name = Name;
