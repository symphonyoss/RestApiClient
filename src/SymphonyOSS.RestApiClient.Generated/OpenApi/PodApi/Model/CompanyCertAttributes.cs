...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.PodApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyCertAttributes :  IEquatable<CompanyCertAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public CompanyCertAttributes(string Name = default(string), CompanyCertType Type = default(CompanyCertType), CompanyCertStatus Status = default(CompanyCertStatus))
        {
            this.Name = Name;
            this.Type = Type;
            this.Status = Status;
