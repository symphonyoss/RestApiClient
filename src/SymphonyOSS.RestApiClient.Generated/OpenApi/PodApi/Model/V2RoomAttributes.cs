...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.PodApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2RoomAttributes :  IEquatable<V2RoomAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public V2RoomAttributes(string Name = default(string), List<RoomTag> Keywords = default(List<RoomTag>), string Description = default(string), bool? MembersCanInvite = default(bool?), bool? Discoverable = default(bool?), bool? _Public = default(bool?), bool? _ReadOnly = default(bool?), bool? CopyProtected = default(bool?))
        {
            this.Name = Name;
