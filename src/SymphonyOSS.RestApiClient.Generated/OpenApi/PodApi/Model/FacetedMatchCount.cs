...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.PodApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FacetedMatchCount :  IEquatable<FacetedMatchCount>, IValidatableObject
    {
        /// <summary>
        ...
        public FacetedMatchCount(string Facet = default(string), int? Count = default(int?))
        {
            this.Facet = Facet;
            this.Count = Count;
        }
