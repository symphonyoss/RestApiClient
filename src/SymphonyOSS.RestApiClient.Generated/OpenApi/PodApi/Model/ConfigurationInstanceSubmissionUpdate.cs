...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.PodApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationInstanceSubmissionUpdate :  IEquatable<ConfigurationInstanceSubmissionUpdate>, IValidatableObject
    {
        /// <summary>
        ...
        public ConfigurationInstanceSubmissionUpdate(string InstanceId = default(string), string ConfigurationId = default(string), string Name = default(string), string Description = default(string), string OptionalProperties = default(string))
        {
