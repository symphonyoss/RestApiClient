...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.PodApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationInstanceResponse :  IEquatable<ConfigurationInstanceResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ConfigurationInstanceResponse(string InstanceId = default(string), string ConfigurationId = default(string), bool? Active = default(bool?), string Name = default(string), string Description = default(string), string CreatorId = default(string), long? CreatedDate = default(long?), string OptionalProperties = default(string))
        {
