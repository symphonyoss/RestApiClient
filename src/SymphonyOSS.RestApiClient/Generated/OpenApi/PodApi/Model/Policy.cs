...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.PodApi.Model
{
    ...
    public partial class Policy :  IEquatable<Policy>
    {
        ...
        public Policy(string Id = default(string), PolicyTypeEnum? PolicyType = default(PolicyTypeEnum?), bool? Active = default(bool?), int? MemberCount = default(int?), List<string> Groups = default(List<string>), long? CreatedDate = default(long?), long? ModifiedDate = default(long?))
        {
            this.Id = Id;
