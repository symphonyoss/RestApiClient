...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.PodApi.Model
{
    ...
    public partial class Group :  IEquatable<Group>
    {
        ...
        public Group(string Id = default(string), string Name = default(string), bool? Active = default(bool?), int? MemberCount = default(int?), List<string> Policies = default(List<string>), long? CreatedDate = default(long?), long? ModifiedDate = default(long?))
        {
            this.Id = Id;
            this.Name = Name;
            this.Active = Active;
