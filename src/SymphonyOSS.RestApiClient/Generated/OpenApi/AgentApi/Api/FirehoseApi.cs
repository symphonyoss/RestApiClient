...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Api
{
    ...
    public interface IFirehoseApi : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// A firehose provides all user entered messages that occur within a Symphony pod beginning at the point in time that it is created.  This also includes system messages like new users joining a chatroom.  Note that unlike a datafeed, the user calling a firehose does not need to be a member of the conversations for which it will receive messages.  A firehose can only be created and accessed by a user with the content export role.  A firehose will expire if its capacity for unread messages is reached. 
        /// </remarks>
        /// <exception cref="SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sessionToken">Session authentication token.</param>
        /// <param name="keyManagerToken">Key Manager authentication token.</param>
        /// <returns>Firehose</returns>
        Firehose V4FirehoseCreatePost (string sessionToken, string keyManagerToken);
        ...
        /// <param name="keyManagerToken">Key Manager authentication token.</param>
        /// <returns>ApiResponse of Firehose</returns>
        ApiResponse<Firehose> V4FirehoseCreatePostWithHttpInfo (string sessionToken, string keyManagerToken);
        /// <summary>
        /// LIMITED RELEASE Read a given firehose.
        /// </summary>
        /// <remarks>
        ...
        V4EventList V4FirehoseIdReadGet (string id, string sessionToken, string keyManagerToken, int? limit = null);
        ...
        ApiResponse<V4EventList> V4FirehoseIdReadGetWithHttpInfo (string id, string sessionToken, string keyManagerToken, int? limit = null);
        ...
        /// <param name="keyManagerToken">Key Manager authentication token.</param>
        /// <returns>Task of Firehose</returns>
        System.Threading.Tasks.Task<Firehose> V4FirehoseCreatePostAsync (string sessionToken, string keyManagerToken);
        ...
        /// <param name="keyManagerToken">Key Manager authentication token.</param>
        /// <returns>Task of ApiResponse (Firehose)</returns>
        System.Threading.Tasks.Task<ApiResponse<Firehose>> V4FirehoseCreatePostAsyncWithHttpInfo (string sessionToken, string keyManagerToken);
        /// <summary>
        /// LIMITED RELEASE Read a given firehose.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<V4EventList> V4FirehoseIdReadGetAsync (string id, string sessionToken, string keyManagerToken, int? limit = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<V4EventList>> V4FirehoseIdReadGetAsyncWithHttpInfo (string id, string sessionToken, string keyManagerToken, int? limit = null);
    ...
    public partial class FirehoseApi : IFirehoseApi
    {
        ...
        /// <param name="keyManagerToken">Key Manager authentication token.</param>
        /// <returns>Firehose</returns>
        public Firehose V4FirehoseCreatePost (string sessionToken, string keyManagerToken)
        {
             ApiResponse<Firehose> localVarResponse = V4FirehoseCreatePostWithHttpInfo(sessionToken, keyManagerToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="keyManagerToken">Key Manager authentication token.</param>
        /// <returns>ApiResponse of Firehose</returns>
        public ApiResponse< Firehose > V4FirehoseCreatePostWithHttpInfo (string sessionToken, string keyManagerToken)
        {
            // verify the required parameter 'sessionToken' is set
            if (sessionToken == null)
                throw new ApiException(400, "Missing required parameter 'sessionToken' when calling FirehoseApi->V4FirehoseCreatePost");
            // verify the required parameter 'keyManagerToken' is set
            if (keyManagerToken == null)
                throw new ApiException(400, "Missing required parameter 'keyManagerToken' when calling FirehoseApi->V4FirehoseCreatePost");

            var localVarPath = "./v4/firehose/create";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("V4FirehoseCreatePost", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="keyManagerToken">Key Manager authentication token.</param>
        /// <returns>Task of Firehose</returns>
        public async System.Threading.Tasks.Task<Firehose> V4FirehoseCreatePostAsync (string sessionToken, string keyManagerToken)
        {
             ApiResponse<Firehose> localVarResponse = await V4FirehoseCreatePostAsyncWithHttpInfo(sessionToken, keyManagerToken);
             return localVarResponse.Data;
        ...
        /// <param name="keyManagerToken">Key Manager authentication token.</param>
        /// <returns>Task of ApiResponse (Firehose)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Firehose>> V4FirehoseCreatePostAsyncWithHttpInfo (string sessionToken, string keyManagerToken)
        {
            // verify the required parameter 'sessionToken' is set
            if (sessionToken == null)
                throw new ApiException(400, "Missing required parameter 'sessionToken' when calling FirehoseApi->V4FirehoseCreatePost");
        ...
        /// <param name="limit">Max No. of messages to return.  (optional)</param>
        /// <returns>V4EventList</returns>
        public V4EventList V4FirehoseIdReadGet (string id, string sessionToken, string keyManagerToken, int? limit = null)
        {
             ApiResponse<V4EventList> localVarResponse = V4FirehoseIdReadGetWithHttpInfo(id, sessionToken, keyManagerToken, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">Max No. of messages to return.  (optional)</param>
        /// <returns>ApiResponse of V4EventList</returns>
        public ApiResponse< V4EventList > V4FirehoseIdReadGetWithHttpInfo (string id, string sessionToken, string keyManagerToken, int? limit = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling FirehoseApi->V4FirehoseIdReadGet");
            // verify the required parameter 'sessionToken' is set
            if (sessionToken == null)
                throw new ApiException(400, "Missing required parameter 'sessionToken' when calling FirehoseApi->V4FirehoseIdReadGet");
            // verify the required parameter 'keyManagerToken' is set
            if (keyManagerToken == null)
                throw new ApiException(400, "Missing required parameter 'keyManagerToken' when calling FirehoseApi->V4FirehoseIdReadGet");

            var localVarPath = "./v4/firehose/{id}/read";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("V4FirehoseIdReadGet", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="limit">Max No. of messages to return.  (optional)</param>
        /// <returns>Task of V4EventList</returns>
        public async System.Threading.Tasks.Task<V4EventList> V4FirehoseIdReadGetAsync (string id, string sessionToken, string keyManagerToken, int? limit = null)
        {
             ApiResponse<V4EventList> localVarResponse = await V4FirehoseIdReadGetAsyncWithHttpInfo(id, sessionToken, keyManagerToken, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">Max No. of messages to return.  (optional)</param>
        /// <returns>Task of ApiResponse (V4EventList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<V4EventList>> V4FirehoseIdReadGetAsyncWithHttpInfo (string id, string sessionToken, string keyManagerToken, int? limit = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling FirehoseApi->V4FirehoseIdReadGet");
