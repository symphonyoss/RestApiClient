...
namespace SymphonyOSS.RestApiClient.Generated.OpenApi.AgentApi.Api
{
    ...
    public interface IAttachmentsApi : IApiAccessor
    {
        ...
        /// <returns>AttachmentInfo</returns>
        AttachmentInfo V3StreamSidAttachmentCreatePost (string sid, string sessionToken, System.IO.Stream file, string keyManagerToken = null);
        ...
        /// <param name="keyManagerToken">Key Manager authentication token. (optional)</param>
        /// <returns>ApiResponse of AttachmentInfo</returns>
        ApiResponse<AttachmentInfo> V3StreamSidAttachmentCreatePostWithHttpInfo (string sid, string sessionToken, System.IO.Stream file, string keyManagerToken = null);
        ...
        /// <param name="keyManagerToken">Key Manager authentication token. (optional)</param>
        /// <returns>Task of AttachmentInfo</returns>
        System.Threading.Tasks.Task<AttachmentInfo> V3StreamSidAttachmentCreatePostAsync (string sid, string sessionToken, System.IO.Stream file, string keyManagerToken = null);
        ...
        /// <param name="keyManagerToken">Key Manager authentication token. (optional)</param>
        /// <returns>Task of ApiResponse (AttachmentInfo)</returns>
        System.Threading.Tasks.Task<ApiResponse<AttachmentInfo>> V3StreamSidAttachmentCreatePostAsyncWithHttpInfo (string sid, string sessionToken, System.IO.Stream file, string keyManagerToken = null);
    ...
    public partial class AttachmentsApi : IAttachmentsApi
    {
        ...
        public ApiResponse< byte[] > V1StreamSidAttachmentGetWithHttpInfo (string sid, string fileId, string messageId, string sessionToken, string keyManagerToken)
        {
            ...
            if (sid != null) localVarPathParams.Add("sid", Configuration.ApiClient.ParameterToString(sid)); // path parameter
            if (fileId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "fileId", fileId)); // query parameter
            if (messageId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "messageId", messageId)); // query parameter
            if (sessionToken != null) localVarHeaderParams.Add("sessionToken", Configuration.ApiClient.ParameterToString(sessionToken)); // header parameter
            if (keyManagerToken != null) localVarHeaderParams.Add("keyManagerToken", Configuration.ApiClient.ParameterToString(keyManagerToken)); // header parameter
        ...
        /// <param name="keyManagerToken">Key Manager authentication token. (optional)</param>
        /// <returns>AttachmentInfo</returns>
        public AttachmentInfo V3StreamSidAttachmentCreatePost (string sid, string sessionToken, System.IO.Stream file, string keyManagerToken = null)
        {
             ApiResponse<AttachmentInfo> localVarResponse = V3StreamSidAttachmentCreatePostWithHttpInfo(sid, sessionToken, file, keyManagerToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="keyManagerToken">Key Manager authentication token. (optional)</param>
        /// <returns>ApiResponse of AttachmentInfo</returns>
        public ApiResponse< AttachmentInfo > V3StreamSidAttachmentCreatePostWithHttpInfo (string sid, string sessionToken, System.IO.Stream file, string keyManagerToken = null)
        {
            // verify the required parameter 'sid' is set
            if (sid == null)
                throw new ApiException(400, "Missing required parameter 'sid' when calling AttachmentsApi->V3StreamSidAttachmentCreatePost");
            // verify the required parameter 'sessionToken' is set
            if (sessionToken == null)
                throw new ApiException(400, "Missing required parameter 'sessionToken' when calling AttachmentsApi->V3StreamSidAttachmentCreatePost");
            // verify the required parameter 'file' is set
            if (file == null)
                throw new ApiException(400, "Missing required parameter 'file' when calling AttachmentsApi->V3StreamSidAttachmentCreatePost");

            var localVarPath = "./v3/stream/{sid}/attachment/create";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("V3StreamSidAttachmentCreatePost", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="keyManagerToken">Key Manager authentication token. (optional)</param>
        /// <returns>Task of AttachmentInfo</returns>
        public async System.Threading.Tasks.Task<AttachmentInfo> V3StreamSidAttachmentCreatePostAsync (string sid, string sessionToken, System.IO.Stream file, string keyManagerToken = null)
        {
             ApiResponse<AttachmentInfo> localVarResponse = await V3StreamSidAttachmentCreatePostAsyncWithHttpInfo(sid, sessionToken, file, keyManagerToken);
             return localVarResponse.Data;
        ...
        /// <param name="keyManagerToken">Key Manager authentication token. (optional)</param>
        /// <returns>Task of ApiResponse (AttachmentInfo)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AttachmentInfo>> V3StreamSidAttachmentCreatePostAsyncWithHttpInfo (string sid, string sessionToken, System.IO.Stream file, string keyManagerToken = null)
        {
            // verify the required parameter 'sid' is set
            if (sid == null)
                throw new ApiException(400, "Missing required parameter 'sid' when calling AttachmentsApi->V3StreamSidAttachmentCreatePost");
